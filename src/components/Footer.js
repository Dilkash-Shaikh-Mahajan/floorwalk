                            ...
                            <Col md="4">
                                <div className="footer-logo-info">
                                    ...
                                    <ul className="list-unstyled">
                                        <li><i className="las la-phone"></i>+91-783-606-6777</li>
                                        <li><i className="las la-envelope"></i>contactus@floorwalk.in</li>
                                        <li><i className="las la-map-marker"></i>Plot No. 165, Bhagyashree Layout, Near Trimurti Nagar, Nagpur, Maharashtra, 440022</li>
                                    </ul>
                                </div>
                            </Col>
                            <Col md="4">
                        ...
                        <Row>
                            <Col md="6">
                                <div className="copy-text">
                                    <p>Copyright &copy; 2023 | Developed by <a href="https://www.budventure.technology/" target="_blank" rel="noopener noreferrer">Budventure Technologies</a></p>
                                </div>
                            </Col>
