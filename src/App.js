	...
	return (
		<Router>
			...
			<Switch>
				...
				<Route
					path={`${
						process.env.PUBLIC_URL + '/course-grid'
					}`}
					component={CourseGrid}
				/>
				<Route
					path={`${
						process.env.PUBLIC_URL + '/course-list'
					}`}
				...
				<Route
					path={`${
						process.env.PUBLIC_URL + '/event-details'
					}`}
				...
				<Route
					path={`${
						process.env.PUBLIC_URL + '/registration'
					}`}
					component={Register}
				/>
				<Route
				...
				<Route
					path={`${
						process.env.PUBLIC_URL + '/coming-soon'
					}`}
					component={ComingSoon}
				/>
				<Route
					path={`${
						process.env.PUBLIC_URL + '/blog-classic'
					}`}
				...
				<Route
					path={`${
						process.env.PUBLIC_URL + '/product-details'
					}`}
				...
				<Route
					path={`${
						process.env.PUBLIC_URL + '/user_dashboard'
					}`}
